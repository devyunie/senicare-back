...
public class GetChargedCustomerResponseDto extends ResponseDto{
    ...
    private GetChargedCustomerResponseDto(List<CustomerEntity> customerEntites) {
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
        this.customers = ChargedCustomer.getList(customerEntites);
    }
    
    public static ResponseEntity<GetChargedCustomerResponseDto> success(List<CustomerEntity> customerEntites){
        GetChargedCustomerResponseDto responseBody = new GetChargedCustomerResponseDto(customerEntites);
